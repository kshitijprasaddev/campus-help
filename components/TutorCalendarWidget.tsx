  ...
  return (
    <section className="container">
      <div className="grid gap-5 lg:grid-cols-[1.05fr_1.25fr]">
        <div className="rounded-[32px] border border-[var(--border)]/60 bg-[rgba(8,12,22,0.9)] p-6 md:p-8 shadow-[0_40px_140px_-110px_rgba(8,16,45,0.95)]">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <div className="tag">Tutor calendar</div>
              <h3 className="mt-3 text-2xl font-semibold text-white">Plan ahead with live availability.</h3>
            </div>
            <div className="flex items-center gap-2 rounded-full border border-[var(--border)]/60 bg-white/[0.04] px-3 py-1 text-xs text-white/55">
              <button
                type="button"
                className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[var(--border)]/60 text-white/70 transition hover:text-white"
              ...
              <span className="min-w-[120px] text-center text-white/80">{monthLabel}</span>
              <button
                type="button"
                className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[var(--border)]/60 text-white/70 transition hover:text-white"
                onClick={() => goToAdjacentMonth(1)}
              ...
              <button
                type="button"
                className="ml-1 rounded-full border border-[var(--border)]/60 px-3 py-1 text-white/70 transition hover:text-white"
                onClick={goToToday}
              >
                Today
              </button>
          ...
          {loading ? (
            <div className="mt-6 animate-pulse space-y-4">
              <div className="h-12 rounded-3xl bg-white/[0.05]" />
            ...
            <>
              ...
              <div className="mt-6 rounded-3xl border border-[var(--border)]/60 bg-white/[0.05] p-5">
                ...
                <div className="mt-4 space-y-3">
                  {selectedSlots.length === 0 ? (
                    <div className="rounded-2xl border border-[var(--border)]/60 bg-white/[0.05] p-4 text-sm text-white/60">
        ...
        <div className="rounded-[32px] border border-[#f87171]/35 bg-[rgba(46,12,27,0.35)] p-6 md:p-8 shadow-[0_35px_130px_-120px_rgba(120,30,60,0.7)]">
          ...
          <h3 className="mt-3 text-2xl font-semibold text-white">Need help in the next hour?</h3>
          ...
          {loading ? (
            <div className="mt-6 space-y-4">
              {Array.from({ length: 2 }).map((_, idx) => (
                <div key={idx} className="h-24 animate-pulse rounded-3xl bg-white/[0.05]" />
              ))}
            </div>
          ) : upcomingEmergency ? (
            <div className="mt-6 space-y-4">
              <div className="rounded-3xl border border-white/15 bg-[rgba(15,6,18,0.8)] p-5 text-sm text-white/75">
                ...
                <button
                  type="button"
                  className="btn mt-4 w-full bg-[#f87171] text-white hover:bg-[#fb7185]"
            ...
            <div className="mt-6 rounded-3xl border border-white/15 bg-[rgba(15,6,18,0.8)] p-5 text-sm text-white/65">
