...
export default function MyPage() {
  ...
  const [{ data: reqs, error: reqErr }, { data: reps, error: repErr }, { data: bids, error: bidsErr }] = await Promise.all([
        ...
        if (reqErr || repErr || bidsErr) {
          ...
          const normalisedBids: Bid[] = (bids || []).map((entry: any) => {
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <section className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <a href="/request/new" className="btn-ghost text-xs">Post more</a>
              </div>
            ...
            <section className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <a href="/tutors" className="btn-ghost text-xs">Browse tutors</a>
              </div>
              <div className="space-y-3">
